...
$(_189).find("span.tree-icon-selected").removeClass("tree-icon-selected");
$(_18a).addClass("tree-node-selected");
$(_18a).find("span.tree-icon").addClass("tree-icon-selected");
...
/*tree.find("span.tree-icon-selected").removeClass("tree-icon-selected");*/
$.map(tree.tree("getChecked"),function(node){
