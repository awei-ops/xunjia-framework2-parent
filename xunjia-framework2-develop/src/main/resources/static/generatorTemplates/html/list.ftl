				...
				<#if prop.searchFlag == 1 && prop.searchCond??>
				    ...
				    <#else>
                        ...
                        <#else>
                            ...
                            <#elseif prop.type == "Date">
                                <input id="${entity.entityName?uncap_first}-${prop.propName}-key" class="easyui-datebox" data-options="width:240,editable:false,label:'${prop.propDescr}：' ,labelAlign:'right',labelWidth:80" />
                            <#else>
                                <#if prop.dicFlag == 1>
                                    <select id="${entity.entityName?uncap_first}-${prop.propName}-key" class="easyui-combobox" data-options="
                                        <#if prop.dicTypeCode??>
