...
import com.xunjia.pes.bizData.oil.service.TSZ_JXPJService;
...
@RestController
@RequestMapping("/tsz_jxpj")
public class TSZ_JXPJController {
    @Autowired
    private TSZ_JXPJService service;
    @ApiOperation(value = "跳转至数据列表页", httpMethod = "GET")
    @RequestMapping("/toList")
    @RequiresPermissions("tsz_jxpj:list")
    public ModelAndView toList() {
        return new ModelAndView("bizData/oil/tsz_jxpj_list");
    }
    ...
    public ModelAndView toRelativeJXPJ() {
        return new ModelAndView("bizData/oil/tsz_relative_jxpj");
    }
    ...
    public ModelAndView toPortraitJXPJ() {
        return new ModelAndView("bizData/oil/tsz_bar_chart");
    }
    ...
    public ModelAndView toComprehensiveJXPJ() {
        return new ModelAndView("bizData/oil/tsz_comprehensive_jxpj");
    }
