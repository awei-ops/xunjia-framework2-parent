...
import com.xunjia.pes.sync.waterInjection.DMGC_S_D_ZSBRSJ_Sync;
...
@RestController
@RequestMapping("/dmgc_s_d_zsbrsj_sync")
public class DMGC_S_D_ZSBRSJ_Sync_Controller {
    @Autowired
    private DMGC_S_D_ZSBRSJ_Sync service;
