...
import com.xunjia.pes.sync.waterTreatment.DMGC_S_D_SBYX_Sync;
...
@RestController
@RequestMapping("/dmgc_s_d_sbyx_sync")
public class DMGC_S_D_SBYX_Sync_Controller {
    @Autowired
    private DMGC_S_D_SBYX_Sync service;
