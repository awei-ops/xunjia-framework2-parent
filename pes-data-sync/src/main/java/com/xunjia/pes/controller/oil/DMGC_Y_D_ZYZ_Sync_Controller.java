...
import com.xunjia.pes.sync.oil.DMGC_Y_D_ZYZ_Sync;
...
@RestController
@RequestMapping("/dmgc_y_d_zyz_sync")
public class DMGC_Y_D_ZYZ_Sync_Controller {
    @Autowired
    private DMGC_Y_D_ZYZ_Sync service;
