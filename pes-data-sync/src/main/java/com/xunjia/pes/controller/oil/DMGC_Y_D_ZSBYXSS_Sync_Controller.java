...
import com.xunjia.pes.sync.oil.DMGC_Y_D_ZSBYXSS_Sync;
...
@RestController
@RequestMapping("/dmgc_y_d_zsbyxss_sync")
public class DMGC_Y_D_ZSBYXSS_Sync_Controller {
    @Autowired
    private DMGC_Y_D_ZSBYXSS_Sync service;
