...
import com.xunjia.pes.sync.oil.DMGC_Y_D_SYB_Sync;
...
@RestController
@RequestMapping("/dmgc_y_d_syb_sync")
public class DMGC_Y_D_SYB_Sync_Controller {
    @Autowired
    private DMGC_Y_D_SYB_Sync service;
