...
import com.xunjia.pes.sync.oil.DMGC_Y_D_TSZ_NEW_Sync;
...
@RestController
@RequestMapping("/dmgc_y_d_tsz_new_sync")
public class DMGC_Y_D_TSZ_NEW_Sync_Controller {
    @Autowired
    private DMGC_Y_D_TSZ_NEW_Sync service;
